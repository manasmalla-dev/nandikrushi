                        ...
                        appBarWithTitle(context,
                          ...
                          pageIndex == 0
                            ...
                            subtitle: pageIndex == 0
                                ? '${items.isNotEmpty ? items.map((e) => int.tryParse(e['quantity'] ?? "0") ?? 0).reduce((value, element) => value + element) : 0} items'
                                : null,
                        ...
                        Expanded(
                          child: pageIndex == 0
                              ? CartItems(
                                  ...
                                  onRemoveItem: (index) {
                                    setState(() {
                                      var currentQuantity = (int.tryParse(
    ...
    return items.isEmpty
        ? Column(
            children: [
              ...
              TextWidget(
                text: 'Looks like you have no items in your shopping basket',
