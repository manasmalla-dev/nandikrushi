                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        ...
                                                                        style: Theme.of(context)
                                                                            .textTheme
                                                                            .bodyMedium
                                                                            ?.copyWith(color: productProvider.orders[itemIndex]["order_status"] == "1" ? Colors.orange.shade900.withOpacity(0.6) : Theme.of(context).colorScheme.primary.withOpacity(0.6)),
                                                                      ),
                                                                    ],
                                                                  ),
                                                                ],
